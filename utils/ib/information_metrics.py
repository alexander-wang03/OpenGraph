"""
Information-theoretic metrics: entropy, mutual information, JS-divergence.

Transplanted verbatim from opennav_mem/star/clio_batch/information_metrics.py.
"""
...
def mutual_information(px, pc, pc_x):
    ...
    log_term[log_term == 0] = 1  # avoid log(0)
